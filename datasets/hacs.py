...
class HACSDetection(torch.utils.data.Dataset):
    def __init__(self, feature_folder, tem_folder, anno_file, split, args):
        ...
        for vid in video_list:
            # if self.split in vid:
                ...
                filename = os.path.join(self.feature_folder, vid +'.npy')
...
def build(split, args):
    ...
    dataset = HACSDetection(feature_folder, tem_folder, anno_file, split,
                              args)
    return dataset
