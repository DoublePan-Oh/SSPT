...
class VideoRecord:
    def __init__(self, vid, locations, num_frames, gt, fps, args, patches):
        self.id = vid
    ...
    def __init__(self, feature_folder, tem_folder, anno_file, split, args):
        ...
        for vid in video_list:
            # if self.split in vid:
                ...
                frames = []
                for frame in range(3, num_frames, self.interval):
                    frames.append(frame)
                ...
                if seq_len <= self.window_size:
                    ...
                    while len(length) < self.num_patches: # 10 is num_patch
                        ...
                        # indice = torch.tensor([i for i in range(T_start , T_end + 1 )])
